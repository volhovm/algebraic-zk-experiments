...
use crate::proving::bulletproofs::{affine_from_bytes_tai, BulletproofGens, PedersenGens};
use ark_serialize::CanonicalSerialize;

use crate::proving::relations::curve::{
    checked_curve_addition_helper, curve_check, PointRepresentation,
};
use crate::proving::relations::lookup::*;
use crate::proving::relations::rerandomize::*;
use crate::proving::relations::select::*;
...
#[cfg(test)]
mod tests {
    use crate::proving::relations::curve_tree::SelRerandParameters;
    ...
    fn test_single_level() {
        ...
        let rerandomized_child = (child
            + (sr_params.even_parameters.pc_gens.B_blinding * rerandomization))
            .into_affine();
